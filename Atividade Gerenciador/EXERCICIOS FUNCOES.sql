...
-- ATIVIDADE 2 --
SELECT PedidoID, DataPedido, ValorTotal, Valortotal*1.1 AS Acrescimo FROM Pedidos;

-- ATIVIDADE 3 --
SELECT PedidoId, DataPedido, ValorTotal, ValorTotal *1.1 AS Acrescentado, ValorTotal *.1 AS ValorAcrescentado FROM Pedidos;
...
-- ATIVIDADE 6 --
SELECT DATEDIFF(current_date,DataPedido) AS Diferença FROM Pedidos;

-- ATIVIDADE 7 --
SELECT*, DATEDIFF(current_date,DataPedido) AS Diferença, DATE_ADD(DataPedido, interval 15 day) AS Adicao15Dias FROM Pedidos ;
